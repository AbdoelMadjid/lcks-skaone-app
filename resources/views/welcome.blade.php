                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <div class="">
                                @if (Route::has('login'))
                                    ...
                                    @endauth
                                @endif
                                {{-- <a href="/auth_signin_basic"
                                    class="btn btn-link fw-medium text-decoration-none text-dark">Sign
                                    in</a>
                                <a href="/auth_signup_basic" class="btn btn-primary">Sign Up</a> --}}
                            </div>
                        </div>
                            ...
                            <div class="col-lg-8 col-sm-10">
                                <div class="text-center mt-lg-5 pt-5">
                                    ...
                                    <div class="d-flex gap-2 justify-content-center mt-4">
                                        <a href="/auth_signup_basic" class="btn btn-primary">Get Started <i
                                                class="ri-arrow-right-line align-middle ms-1"></i></a>
                                        <a href="/pages_pricing" class="btn btn-danger">View Plans <i
                        ...
                        <div class="row align-items-center gy-4">
                            <div class="col-lg-6 order-2 order-lg-1">
                                <div class="text-muted">
                                    ...
                                    <div class="mt-4">
                                        <a href="/dashboard" class="btn btn-primary">Learn More <i
                                                class="ri-arrow-right-line align-middle ms-1"></i></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="card">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <!-- end card body -->
                                        <h5 class="mb-1"><a href="/pages_profile_basic" class="text-body">Nancy
                                                Martino</a>
                                        </h5>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="card">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <!-- end card body -->
                                        <h5 class="mb-1"><a href="/pages_profile_basic" class="text-body">Henry
                                                Baird</a></h5>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="card">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <!-- end card body -->
                                        <h5 class="mb-1"><a href="/pages_profile_basic" class="text-body">Frank
                                                Hook</a>
                                        </h5>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="card">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <!-- end card body -->
                                        <h5 class="mb-1"><a href="/pages_profile_basic" class="text-body">Donald
                                                Palmer</a>
                                        </h5>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="card">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <!-- end card body -->
                                        <h5 class="mb-1"><a href="/pages_profile_basic" class="text-body">Erica
                                                Kernan</a>
                                        </h5>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="card">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <!-- end card body -->
                                        <h5 class="mb-1"><a href="/pages_profile_basic" class="text-body">Alexis
                                                Clarke</a>
                                        </h5>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="card">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <!-- end card body -->
                                        <h5 class="mb-1"><a href="/pages_profile_basic" class="text-body">Marie
                                                Ward</a></h5>
                                        <p class="text-muted mb-0 ff-secondary">Full Stack Developer</p>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="card">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <!-- end card body -->
                                        <h5 class="mb-1"><a href="/pages_profile_basic" class="text-body">Jack
                                                Gough</a></h5>
