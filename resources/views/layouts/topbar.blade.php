            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <!-- item-->
                        <a href="{{ route('lang.switch', 'en') }}" class="dropdown-item notify-item language py-2"
                        ...
                        <!-- item-->
                        <a href="{{ route('lang.switch', 'gr') }}" class="dropdown-item notify-item language"
                        ...
                        <!-- item-->
                        <a href="{{ route('lang.switch', 'it') }}" class="dropdown-item notify-item language"
                        ...
                        <!-- item-->
                        <a href="{{ route('lang.switch', 'ru') }}" class="dropdown-item notify-item language"
                        ...
                        <!-- item-->
                        <a href="{{ route('lang.switch', 'fr') }}" class="dropdown-item notify-item language"
                        ...
                        <!-- item-->
                        <a href="{{ route('lang.switch', 'ae') }}" class="dropdown-item notify-item language"
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="/pages_profile_basic"><i
                                class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span
                                class="align-middle">Profile</span></a>
                        <a class="dropdown-item" href="/apps_chat"><i
                                class="mdi mdi-message-text-outline text-muted fs-16 align-middle me-1"></i> <span
                                class="align-middle">Messages</span></a>
                        <a class="dropdown-item" href="/apps_tasks_kanban"><i
                                class="mdi mdi-calendar-check-outline text-muted fs-16 align-middle me-1"></i> <span
                                class="align-middle">Taskboard</span></a>
                        <a class="dropdown-item" href="/pages_faqs"><i
                        ...
                        <a class="dropdown-item" href="/pages_profile_settings"><span
                                class="badge bg-success-subtle text-success mt-1 float-end">New</span><i
                                class="mdi mdi-cog-outline text-muted fs-16 align-middle me-1"></i> <span
                                class="align-middle">Settings</span></a>
                        <a class="dropdown-item" href="/auth_lockscreen_basic"><i
